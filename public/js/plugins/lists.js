  ...
  _initAddingViaJS() {
    if (document.getElementById('addingViaJS')) {
      ...
      var values = [
        {
          name: 'Peg Bread',
          image: Helpers.UrlFix('/img/product/small/pullman-loaf.jpg'),
        },
        {
          name: 'Tunnbröd',
          image: Helpers.UrlFix('/img/product/small/steirer-brot.jpg'),
        },
        {
          name: 'Samoon',
          image: Helpers.UrlFix('/img/product/small/barmbrack.jpg'),
        },
        {
          name: 'Rieska',
          image: Helpers.UrlFix('/img/product/small/baguette.jpg'),
        },
      ];
