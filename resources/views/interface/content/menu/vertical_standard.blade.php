@php
    ...
    $title = 'Vertical Menu';
    $description = 'Standard vertical menu that can be pinned for larger screens, switches to semi-hidden state for tablet sizes and shows mobile menu for smaller screens.';
