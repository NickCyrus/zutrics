@php
    $html_tag_data = [];
    $title = 'CS Line Icons';
    $description = 'A cute line icon set crafted exclusively for Acorn.';
                    ...
                    <div class="card mb-2">
                        <div class="card-body text-center position-relative p-0">
                            <input class="form-control borderless m-0 py-3 px-3 rounded-lg" type="text"
                                   ...
                                   id="csLineIconsSearch"/>
                            <i data-cs-icon="search" class="search-input-icon text-muted"></i>
                        </div>
                    </div>

                    <div class="row g-2 row-cols-3 row-cols-md-4 row-cols-lg-6" id="csLineIconsContainer">
