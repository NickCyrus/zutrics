...
@section('js_page')
    ...
    <script src="{{ asset('/js/plugins/datatable.ajax.js') }}"></script>
@endsection
                        ...
                        <div class="col-sm-12 col-md-7 col-lg-9 col-xxl-10 text-end mb-1">
                            ...
                            <div class="d-inline-block">
                                ...
                                <button
                                    ...
                                    data-bs-delay="0" data-datatable="#datatableRowsAjax" data-bs-toggle="tooltip"
                  ...
                  <span class="btn btn-icon btn-icon-only btn-foreground-alternate shadow dropdown" data-bs-delay="0"
                    ...
                    <i data-cs-icon="download"></i>
                                ...
                                <div class="dropdown-as-select d-inline-block datatable-length"
                                     data-datatable="#datatableRowsAjax" data-childSelector="span">
